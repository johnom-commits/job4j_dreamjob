            ...
            <div class="card-body" id="post">
                <form action="<%=request.getContextPath()%>/posts.do?id=<%=post.getId()%>" method="post">
                    <div class="form-group">
                        <label for="namePost">Имя</label>
                        <input type="text" class="form-control" name="name" id="namePost" value="<%=post.getName()%>"
...
<script>
    document.querySelector('#post').addEventListener('submit', checkNamePost);

    function checkNamePost(event) {
